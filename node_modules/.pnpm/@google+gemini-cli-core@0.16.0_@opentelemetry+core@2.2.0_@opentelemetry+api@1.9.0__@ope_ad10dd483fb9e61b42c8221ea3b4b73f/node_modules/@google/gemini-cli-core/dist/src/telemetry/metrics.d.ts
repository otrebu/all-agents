 ...
 */
export declare function recordContentRetry(config: Config, errorType: string): void;
/**
 * Records a metric for when all content error retries have failed for a request.
 */
export declare function recordContentRetryFailure(config: Config, errorType: string): void;
