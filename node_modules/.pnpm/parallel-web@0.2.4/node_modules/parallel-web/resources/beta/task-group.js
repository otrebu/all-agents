...
class TaskGroup extends resource_1.APIResource {
    ...
    create(body, options) {
        return this._client.post('/v1beta/tasks/groups', {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ 'parallel-beta': 'search-extract-2025-10-10' }, options?.headers]),
        });
    }
    /**
    ...
    retrieve(taskGroupID, options) {
        return this._client.get((0, path_1.path) `/v1beta/tasks/groups/${taskGroupID}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ 'parallel-beta': 'search-extract-2025-10-10' }, options?.headers]),
        });
    }
