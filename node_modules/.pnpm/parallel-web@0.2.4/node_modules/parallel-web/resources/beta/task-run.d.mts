 ...
 */
export type ParallelBeta = 'mcp-server-2025-07-17' | 'events-sse-2025-07-24' | 'webhook-2025-08-12' | 'findall-2025-09-15' | 'search-extract-2025-10-10' | (string & {});
/**
 ...
 */
export type TaskRunEventsResponse = TaskRunEventsResponse.TaskRunProgressStatsEvent | TaskRunEventsResponse.TaskRunProgressMessageEvent | TaskRunEvent | ErrorEvent;
export declare namespace TaskRunEventsResponse {
    /**
     * A progress update for a task run.
     */
    interface TaskRunProgressStatsEvent {
        /**
     ...
     */
    interface TaskRunProgressMessageEvent {
        /**
         ...
         */
        type: 'task_run.progress_msg.plan' | 'task_run.progress_msg.search' | 'task_run.progress_msg.result' | 'task_run.progress_msg.tool_call' | 'task_run.progress_msg.exec_status';
    }
}
...
export declare namespace TaskRun {
    export { type BetaRunInput as BetaRunInput, type BetaTaskRunResult as BetaTaskRunResult, type ErrorEvent as ErrorEvent, type McpServer as McpServer, type McpToolCall as McpToolCall, type ParallelBeta as ParallelBeta, type TaskRunEvent as TaskRunEvent, type Webhook as Webhook, type TaskRunEventsResponse as TaskRunEventsResponse, type TaskRunCreateParams as TaskRunCreateParams, type TaskRunResultParams as TaskRunResultParams, };
}
//# sourceMappingURL=task-run.d.mts.map