...
| Layer    | Reference                                                                                                                        |
| -------- | -------------------------------------------------------------------------------------------------------------------------------- |
| Runtime  | @context/blocks/construct/pnpm.md, @context/blocks/construct/node.md, @context/foundations/construct/bundle-web-vite.md                    |
| Frontend | @context/blocks/construct/react.md, @context/blocks/construct/vite.md, @context/blocks/construct/tailwind.md                     |
| UI       | @context/blocks/construct/shadcn.md                                         |
| Data     | @context/blocks/construct/tanstack-query.md                                                        |
| Testing  | @context/blocks/test/testing.md, @context/blocks/test/storybook.md |
| DX       | @context/foundations/quality/gate-standards.md, @context/blocks/scm/husky.md                                                       |
| Libs     | @context/blocks/construct/date-fns.md, @context/blocks/construct/xstate.md                                                       |
...
See @context/blocks/construct/pnpm.md for full workspace setup. Key gotchas below.
