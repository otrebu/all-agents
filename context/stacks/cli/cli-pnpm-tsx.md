...
| Layer    | Reference                                                                                                     |
| -------- | ------------------------------------------------------------------------------------------------------------- |
| Runtime  | @context/blocks/construct/pnpm.md, @context/blocks/construct/node.md, @context/blocks/construct/tsconfig-base.md |
| CLI      | @context/foundations/observe/log-structured-cli.md                         |
| Testing  | @context/blocks/test/testing.md                                                                     |
| DX       | @context/foundations/quality/gate-standards.md, @context/blocks/scm/husky.md                                    |
| DevOps   | @context/blocks/scm/semantic-release.md                                                                 |
| Libs     | @context/blocks/security/dotenv.md                                                                           |
