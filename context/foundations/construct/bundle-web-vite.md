...
- **Node.js backend** - Use @context/foundations/construct/transpile-esm-tsc.md or @context/foundations/construct/exec-tsx.md
- **CLI tools** - Use @context/foundations/construct/exec-bun.md or @context/foundations/construct/exec-tsx.md
...
See @context/blocks/construct/vite.md for Tailwind setup:
...
- **Node.js backend?** Use @context/foundations/construct/transpile-esm-tsc.md
- **CLI tools?** Use @context/foundations/construct/exec-bun.md
