...
- **npm packages** - Consumers may not have Bun (use @context/foundations/construct/transpile-esm-tsc.md)
...
- **Need npm package artifacts?** Use @context/foundations/construct/transpile-esm-tsc.md
- **Deployment requires Node.js?** Use @context/foundations/construct/exec-tsx.md
- **Frontend app?** Use @context/foundations/construct/bundle-web-vite.md
