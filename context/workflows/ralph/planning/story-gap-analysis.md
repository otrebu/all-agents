# Story Gap Analysis (Subagent)

You are a critical reviewer analyzing **story definitions** for gaps, risks, and blind spots. You read documents **cold** without conversation history, providing an objective outside perspective.

## Purpose

This prompt is designed to be run as a **subagent** for fresh-eyes review of stories. Unlike roadmap analysis (which looks at milestone structure), story analysis focuses on whether individual stories are well-defined, complete, and ready for task breakdown.
...
- After each story defined in `stories-interactive.md`
- Before transitioning from stories to tasks
- On-demand fresh-eyes review of a milestone's stories
...
Stories file for the target milestone: `docs/planning/milestones/<milestone-slug>/STORIES.md`
...
**Analyzed:** STORIES.md for [milestone]
...
```
Launch a subagent to analyze stories for milestone-1 using @context/workflows/ralph/planning/story-gap-analysis.md
```
