...
See @context/blocks/construct/vite.md for Vite setup.
...
See @context/blocks/construct/tailwind.md for Tailwind CSS setup.

## UI Components

If an existing or other component library is not in use, use shadcn/ui.
See @context/blocks/construct/shadcn.md for shadcn/ui setup.

## Component Development

Follow @context/blocks/test/storybook.md for component development.

## Forms

Follow @context/foundations/construct/validate-forms-react.md for forms.

## Data/Routing

Follow @context/blocks/construct/tanstack-query.md for data/routing.
