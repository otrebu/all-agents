...
- Platform: `platform-node-pnpm.md`, `platform-bun.md`
- Monorepo: `monorepo-pnpm-base.md`, `monorepo-bun.md`
- Execution: `exec-{tool}.md`
  - `exec-tsx.md` = tsx runtime
  - `exec-bun.md` = bun runtime
- Bundle: `bundle-{target}-{tool}.md`
  - `bundle-web-vite.md` = Web bundling with Vite
- Transpile: `transpile-{target}-{tool}.md`
  - `transpile-esm-tsc.md` = ESM transpilation with tsc

**Purpose comes first** (platform, monorepo, exec, bundle) then tool/runtime
