...
### Review Skill (NEW) - IMPLEMENTED
- Interactive review of auto-generated artifacts (stories, tasks, roadmap)
- Walks through each item one-by-one:
  1. Quote as-is
  2. Summarize understanding
  3. Validate against parent context
  4. Ask clarifying questions
  5. Offer edit or confirm → save immediately
- Cross-artifact analysis at end: coverage, overlap, dependencies, gaps
- Skill: `/ralph-review stories <milestone>`, `/ralph-review tasks <story-id>` (tasks P2)
