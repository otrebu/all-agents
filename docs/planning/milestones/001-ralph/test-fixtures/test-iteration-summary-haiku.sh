...
if [ ! -f "$REPO_ROOT/prompts/iteration-summary.md" ]; then
    echo "ERROR: Prompt not found at: $REPO_ROOT/prompts/iteration-summary.md"
    exit 1
fi
...
PROMPT_CONTENT=$(cat "$REPO_ROOT/prompts/iteration-summary.md" | \
