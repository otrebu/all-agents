...
- **MANDATORY**: Set `allowed-tools` in frontmatter if tools are used (Ref: `@context/meta/CLAUDE-CODE-TOOLS-PERMISSIONS.md`) you must allow all tools used by the command.
