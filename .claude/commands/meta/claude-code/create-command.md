...
- **MANDATORY**: Set `allowed-tools` in frontmatter if tools are used (Ref: `@context/primitives/principles/claude-code-tools-permissions.md`) you must allow all tools used by the command.
